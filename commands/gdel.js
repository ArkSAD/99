...
if(!args[0])return message.reply(`**Please add the id Message of the giveaway <a:worng:618171880855044129> \`example: #gdel <id Message>\`** `);

        giveaways.delete(messageID).then(() => {
         message.channel.send("**Success! Giveaway deleted! <a:true:618171648394264581>**");
        }).catch((err) => {
